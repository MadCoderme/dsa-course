    ...
    <div className="p-4 sm:p-6 rounded-xl bg-white dark:bg-[#201D1A] border border-[#E5E2D9] dark:border-[#38332B] space-y-6 shadow-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-[#E5E2D9] dark:border-[#38332B]">
        <div>
          <h3 className="text-base font-serif font-bold text-[#1A1A1A] dark:text-[#EDE8DF] flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-[#15803D] dark:text-[#4ADE80]" /> AVL & Multi-Way Tree Laboratory
          </h3>
        ...
        <div className="flex items-center gap-1 bg-[#F4F2EB] dark:bg-[#2A2622] p-1 rounded-lg border border-[#E5E2D9] dark:border-[#38332B]">
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'rotations' ? 'bg-white dark:bg-[#2A2622] text-[#991B1B] dark:text-[#EF4444] shadow-2xs font-bold' : 'text-[#66625B] dark:text-[#A8A29E] hover:text-[#1A1A1A] dark:text-[#EDE8DF] dark:hover:text-[#EDE8DF] dark:hover:text-[#EDE8DF]'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'bst-deletion' ? 'bg-white dark:bg-[#2A2622] text-[#991B1B] dark:text-[#EF4444] shadow-2xs font-bold' : 'text-[#66625B] dark:text-[#A8A29E] hover:text-[#1A1A1A] dark:text-[#EDE8DF] dark:hover:text-[#EDE8DF] dark:hover:text-[#EDE8DF]'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'btree-split' ? 'bg-white dark:bg-[#2A2622] text-[#991B1B] dark:text-[#EF4444] shadow-2xs font-bold' : 'text-[#66625B] dark:text-[#A8A29E] hover:text-[#1A1A1A] dark:text-[#EDE8DF] dark:hover:text-[#EDE8DF] dark:hover:text-[#EDE8DF]'
            }`}
          >
            B-Tree / B+ Node Split
          </button>
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 p-3 rounded-lg bg-[#FAF8F5] dark:bg-[#181614] border border-[#E5E2D9] dark:border-[#38332B]">
            <div className="flex items-center gap-2">
              <span className="text-xs font-serif font-bold text-[#1A1A1A] dark:text-[#EDE8DF]">Rotation Archetype:</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Imbalance (Before) */}
            <div className={`p-4 rounded-xl border transition-all ${rotationStep === 0 ? 'bg-[#FEF2F2]/40 border-[#FECACA]' : 'bg-[#FAF8F5] dark:bg-[#181614] border-[#E5E2D9] dark:border-[#38332B] opacity-60'}`}>
              <div className="flex items-center justify-between pb-2 border-b border-[#E5E2D9] dark:border-[#38332B]">
                <span className="text-xs font-serif font-bold text-[#991B1B] dark:text-[#EF4444]">1. Imbalanced State (Trigger)</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-white dark:bg-[#201D1A] text-[#991B1B] dark:text-[#EF4444] border border-[#FECACA] dark:border-[#7F1D1D]">
                  |BF| = 2
                </span>
              </div>
            ...
            {/* Balanced (After) */}
            <div className={`p-4 rounded-xl border transition-all ${rotationStep === 1 ? 'bg-[#F0FDF4] border-[#BBF7D0]' : 'bg-[#FAF8F5] dark:bg-[#181614] border-[#E5E2D9] dark:border-[#38332B] opacity-60'}`}>
              <div className="flex items-center justify-between pb-2 border-b border-[#E5E2D9] dark:border-[#38332B]">
                <span className="text-xs font-serif font-bold text-[#15803D] dark:text-[#4ADE80]">2. Restored Balance (Post-Rotation)</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-white dark:bg-[#201D1A] text-[#15803D] dark:text-[#4ADE80] border border-[#BBF7D0] dark:border-[#059669]">
                  BF = 0 for all
                </span>
              </div>
              <div className="pt-4 flex justify-center">
      ...
      {activeTab === 'bst-deletion' && (
        <div className="space-y-4">
          <div className="flex items-center gap-2 p-3 rounded-lg bg-[#FAF8F5] dark:bg-[#181614] border border-[#E5E2D9] dark:border-[#38332B]">
            <span className="text-xs font-serif font-bold text-[#1A1A1A] dark:text-[#EDE8DF]">Deletion Scenario:</span>
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-[#201D1A] border border-[#E5E2D9] dark:border-[#38332B] space-y-3">
            {deletionCase === 'leaf' && (
              <div className="space-y-2">
                <div className="text-xs font-serif font-bold text-[#15803D] dark:text-[#4ADE80]">Case 1: Target Node is a Leaf (No Children)</div>
                <p className="text-xs text-[#44403C] dark:text-[#D6D0C5] leading-relaxed">
                  Simply sever the parent pointer pointing to this node (<code className="text-[#991B1B] dark:text-[#EF4444] font-mono">parent-&gt;left = NULL</code> or <code className="text-[#991B1B] dark:text-[#EF4444] font-mono">parent-&gt;right = NULL</code>) and free memory with <code className="text-[#991B1B] dark:text-[#EF4444] font-mono">delete node</code>.
                </p>
                <div className="p-2.5 rounded bg-[#FAF8F5] dark:bg-[#181614] font-mono text-xs text-[#15803D] dark:text-[#4ADE80]">
            ...
            {deletionCase === 'one-child' && (
              <div className="space-y-2">
                <div className="text-xs font-serif font-bold text-[#B45309] dark:text-[#FBBF24]">Case 2: Target Node Has Exactly 1 Child</div>
                <p className="text-xs text-[#44403C] dark:text-[#D6D0C5] leading-relaxed">
                  Bypass the target node! Connect the parent directly to the target node's only child (<code className="text-[#991B1B] dark:text-[#EF4444] font-mono">parent-&gt;link = target-&gt;child</code>), then free the target node.
                </p>
                <div className="p-2.5 rounded bg-[#FAF8F5] dark:bg-[#181614] font-mono text-xs text-[#B45309] dark:text-[#FBBF24]">
            ...
            {deletionCase === 'two-children' && (
              <div className="space-y-2">
                <div className="text-xs font-serif font-bold text-[#991B1B] dark:text-[#EF4444]">Case 3: Target Node Has 2 Children (Inorder Successor Replacement)</div>
                <p className="text-xs text-[#44403C] dark:text-[#D6D0C5] leading-relaxed">
                  You cannot simply delete the node because doing so leaves two orphan subtrees! Instead:
                </p>
                <ol className="list-decimal list-inside space-y-1.5 text-xs text-[#44403C] dark:text-[#D6D0C5] pl-2">
                ...
                <div className="p-2.5 rounded bg-[#FEF2F2] dark:bg-[#450A0A]/40 border border-[#FECACA] dark:border-[#7F1D1D] font-mono text-xs text-[#991B1B] dark:text-[#EF4444] font-bold">
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-[#FAF8F5] dark:bg-[#181614] border border-[#E5E2D9] dark:border-[#38332B] space-y-3">
            <h4 className="text-sm font-serif font-bold text-[#1A1A1A] dark:text-[#EDE8DF] flex items-center gap-2">
              <Split className="w-4 h-4 text-[#991B1B] dark:text-[#EF4444]" /> Order-4 B-Tree Node Overflow & Split Simulation
            </h4>
            <p className="text-xs text-[#44403C] dark:text-[#D6D0C5] leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white dark:bg-[#201D1A] border border-[#E5E2D9] dark:border-[#38332B] flex flex-col items-center gap-4">
              {!splitStage ? (
                <div className="space-y-2 text-center">
                  <span className="text-xs font-serif font-bold text-[#1A1A1A] dark:text-[#EDE8DF]">Leaf Node Before Split (Capacity: 3 / 3):</span>
                  <div className="flex border-2 border-[#1A1A1A] rounded-md overflow-hidden font-mono font-bold text-sm">
                    <span className="px-4 py-2 bg-[#FAF8F5] dark:bg-[#181614] border-r border-[#E5E2D9] dark:border-[#38332B]">10</span>
                    <span className="px-4 py-2 bg-[#FAF8F5] dark:bg-[#181614] border-r border-[#E5E2D9] dark:border-[#38332B]">20</span>
                    <span className="px-4 py-2 bg-[#FAF8F5] dark:bg-[#181614]">30</span>
                  </div>
                </div>
              ) : (
                <div className="space-y-4 text-center">
                  <div className="space-y-1">
                    <span className="text-xs font-serif font-bold text-[#15803D] dark:text-[#4ADE80]">Promoted Median Key to Parent:</span>
                    <div className="inline-flex border-2 border-[#15803D] rounded-md bg-[#F0FDF4] dark:bg-[#064E3B]/40 px-4 py-1.5 font-mono font-bold text-sm text-[#15803D] dark:text-[#4ADE80]">
                      [ 20 ]
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-8">
                    <div className="space-y-1">
                      <span className="text-[11px] font-serif text-[#66625B] dark:text-[#A8A29E]">Left Child Node:</span>
                      <div className="border border-[#1A1A1A] rounded bg-[#FAF8F5] dark:bg-[#181614] px-3 py-1.5 font-mono font-bold text-xs">
                        [ 10 ]
                      </div>
                    </div>
                    <div className="space-y-1">
                      <span className="text-[11px] font-serif text-[#66625B] dark:text-[#A8A29E]">Right Child Node:</span>
                      <div className="border border-[#1A1A1A] rounded bg-[#FAF8F5] dark:bg-[#181614] px-3 py-1.5 font-mono font-bold text-xs">
                        [ 30 | 40 ]
                      </div>
                    </div>

...
export const BstRbtVisualizer: React.FC<BstRbtVisualizerProps> = ({ focusedMode = 'bst-ops' }) => {
  ...
  return (
    <div className="p-4 sm:p-6 rounded-xl bg-white border border-[#E5E2D9] space-y-6 shadow-xs" id="bst-rbt-visualizer-root">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-[#E5E2D9]">
        <div>
          <h3 className="text-base font-serif font-bold text-[#1A1A1A] flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-[#991B1B]" /> Binary Search Tree & Red-Black Tree Laboratory
          </h3>
        ...
        <div className="flex flex-wrap items-center gap-1 bg-[#F4F2EB] p-1 rounded-lg border border-[#E5E2D9]">
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'bst-ops' ? 'bg-white text-[#991B1B] shadow-2xs font-bold' : 'text-[#66625B] hover:text-[#1A1A1A]'
            }`}
          >
            BST Search
          </button>
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'deletion' ? 'bg-white text-[#991B1B] shadow-2xs font-bold' : 'text-[#66625B] hover:text-[#1A1A1A]'
            }`}
          >
            BST 3 Deletions
          </button>
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'rbt-invariants' ? 'bg-white text-[#991B1B] shadow-2xs font-bold' : 'text-[#66625B] hover:text-[#1A1A1A]'
            }`}
          >
            RBT 5 Properties
          </button>
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'rbt-insert' ? 'bg-white text-[#991B1B] shadow-2xs font-bold' : 'text-[#66625B] hover:text-[#1A1A1A]'
            }`}
          >
          ...
          <button
            ...
            className={`px-2.5 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
              activeTab === 'rbt-delete' ? 'bg-white text-[#991B1B] shadow-2xs font-bold' : 'text-[#66625B] hover:text-[#1A1A1A]'
            }`}
          >
      ...
      {activeTab === 'bst-ops' && (
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#E5E2D9] space-y-2">
            <h4 className="text-sm font-serif font-bold text-[#1A1A1A]">Binary Search Tree (BST) Ordering Invariant</h4>
            ...
            <div className="p-2.5 bg-white rounded border border-[#E5E2D9] font-mono text-xs text-[#991B1B] font-bold">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-white border border-[#E5E2D9]">
            <div className="text-xs font-serif font-bold text-[#1A1A1A]">
              Search for Key <span className="font-mono text-[#991B1B] font-bold">65</span>:
            </div>
        ...
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#E5E2D9] space-y-3">
            <h4 className="text-sm font-serif font-bold text-[#1A1A1A] flex items-center gap-2">
              <Trash2 className="w-4 h-4 text-[#991B1B]" /> The 3 Structural BST Deletion Cases
            </h4>
            <p className="text-xs text-[#44403C] leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-white border border-[#E5E2D9] space-y-3">
            {deletionCase === 'leaf' && (
              <div className="space-y-2">
                <div className="text-xs font-serif font-bold text-[#15803D]">Case 1: Deleting Leaf Node (e.g. Delete 20)</div>
                <p className="text-xs text-[#44403C] leading-relaxed">
                ...
                <div className="p-2.5 bg-[#FAF8F5] rounded border border-[#E5E2D9] font-mono text-xs text-[#1A1A1A]">
            ...
            {deletionCase === 'one-child' && (
              <div className="space-y-2">
                <div className="text-xs font-serif font-bold text-[#B45309]">Case 2: Deleting Node with 1 Child (e.g. Delete 30 with Child 40)</div>
                <p className="text-xs text-[#44403C] leading-relaxed">
            ...
            {deletionCase === 'two-children' && (
              <div className="space-y-2">
                <div className="text-xs font-serif font-bold text-[#991B1B]">Case 3: Deleting Node with 2 Children (e.g. Delete Root 50)</div>
                <p className="text-xs text-[#44403C] leading-relaxed">
                  The target node cannot be simply severed because doing so leaves two orphan subtrees. Instead:
                </p>
                <ol className="list-decimal list-inside text-xs text-[#44403C] space-y-1 pl-1">
                ...
                <div className="p-2.5 bg-[#FEF2F2] rounded border border-[#FECACA] font-mono text-xs text-[#991B1B]">
      ...
      {activeTab === 'rbt-invariants' && (
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#E5E2D9] space-y-3">
            <h4 className="text-sm font-serif font-bold text-[#1A1A1A] flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-[#991B1B]" /> The 5 Canonical Red-Black Tree Invariants
            </h4>
            <p className="text-xs text-[#44403C] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              <div key={prop.num} className="p-3.5 rounded-lg bg-white border border-[#E5E2D9] space-y-1">
                ...
                <div className="text-xs text-[#66625B] leading-relaxed pl-7">{prop.desc}</div>
              </div>
            ))}
          </div>
          ...
          <div className="p-4 rounded-xl bg-white border border-[#E5E2D9] space-y-2">
            <div className="text-xs font-serif font-bold text-[#1A1A1A]">Comparison: AVL Tree vs. Red-Black Tree</div>
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs font-sans border-collapse">
                <thead>
                  <tr className="bg-[#F4F2EB] text-[#2C2B29]">
                    <th className="p-2 border border-[#E5E2D9]">Feature</th>
                    <th className="p-2 border border-[#E5E2D9]">AVL Tree</th>
                    <th className="p-2 border border-[#E5E2D9]">Red-Black Tree</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-2 border border-[#E5E2D9] font-bold">Balance Strictness</td>
                    <td className="p-2 border border-[#E5E2D9] text-[#991B1B] font-bold">Strict (|BF| ≤ 1)</td>
                    <td className="p-2 border border-[#E5E2D9] text-[#15803D]">Relaxed (Height ≤ 2 log N)</td>
                  </tr>
                  <tr>
                    <td className="p-2 border border-[#E5E2D9] font-bold">Lookup Speed</td>
                    <td className="p-2 border border-[#E5E2D9] text-[#15803D]">Faster (shorter tree height)</td>
                    <td className="p-2 border border-[#E5E2D9]">Slightly slower</td>
                  </tr>
                  <tr>
                    <td className="p-2 border border-[#E5E2D9] font-bold">Insertion / Deletion</td>
                    <td className="p-2 border border-[#E5E2D9]">More rotations required</td>
                    <td className="p-2 border border-[#E5E2D9] text-[#15803D] font-bold">Faster (mostly recoloring, ≤ 2 rotations on insert, ≤ 3 on delete)</td>
                  </tr>
                  <tr>
                    <td className="p-2 border border-[#E5E2D9] font-bold">Standard Usage</td>
                    <td className="p-2 border border-[#E5E2D9]">Read-heavy lookup databases</td>
                    <td className="p-2 border border-[#E5E2D9] text-[#15803D] font-bold">C++ STL std::set & std::map, Linux Kernel CFS Scheduler</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      {activeTab === 'rbt-insert' && (
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#E5E2D9] space-y-3">
            <h4 className="text-sm font-serif font-bold text-[#1A1A1A] flex items-center gap-2">
              <Plus className="w-4 h-4 text-[#991B1B]" /> Red-Black Tree Insertion Algorithm (Double-Red Fix)
            </h4>
            <p className="text-xs text-[#44403C] leading-relaxed">
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtInsertCase === 'case1' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtInsertCase === 'case2' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtInsertCase === 'case3' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
          ...
          <div className="p-5 rounded-xl bg-white border border-[#E5E2D9] space-y-4">
            {rbtInsertCase === 'case1' && (
              <div className="space-y-3">
                <div className="text-xs font-serif font-bold text-[#991B1B]">
                  Case 1 Resolution: Uncle is RED $\to$ Recolor & Propagate Upwards
                </div>
                <div className="p-3 bg-[#FAF8F5] rounded-lg border border-[#E5E2D9] text-xs text-[#44403C] space-y-1">
                ...
                <div className="flex justify-center p-4 bg-[#FAF8F5] rounded-xl border border-[#E5E2D9] overflow-x-auto">
            ...
            {rbtInsertCase === 'case2' && (
              <div className="space-y-3">
                <div className="text-xs font-serif font-bold text-[#B45309]">
                  Case 2 Resolution: Uncle is BLACK & Zig-Zag (Triangle) $\to$ Rotate Parent to form Line (Case 3)
                </div>
                <div className="p-3 bg-[#FAF8F5] rounded-lg border border-[#E5E2D9] text-xs text-[#44403C]">
            ...
            {rbtInsertCase === 'case3' && (
              <div className="space-y-3">
                <div className="text-xs font-serif font-bold text-[#15803D]">
      ...
      {activeTab === 'rbt-delete' && (
        <div className="space-y-4">
          <div className="p-4 rounded-xl bg-[#FAF8F5] border border-[#E5E2D9] space-y-3">
            <h4 className="text-sm font-serif font-bold text-[#1A1A1A] flex items-center gap-2">
              <Trash2 className="w-4 h-4 text-[#991B1B]" /> Red-Black Tree Deletion (Double-Black Elimination)
            </h4>
            <p className="text-xs text-[#44403C] leading-relaxed">
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtDeleteCase === 'case1' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtDeleteCase === 'case2' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtDeleteCase === 'case3' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer border ${
                  rbtDeleteCase === 'case4' ? 'bg-[#991B1B] text-white border-[#991B1B]' : 'bg-white text-[#44403C] border-[#D8D4C8]'
                }`}
              >
          ...
          <div className="p-5 rounded-xl bg-white border border-[#E5E2D9] space-y-4">
            ...
            <div className="p-3.5 rounded-lg bg-[#F0FDF4] border border-[#DCFCE7] flex items-center justify-between text-xs text-[#14532D]">
